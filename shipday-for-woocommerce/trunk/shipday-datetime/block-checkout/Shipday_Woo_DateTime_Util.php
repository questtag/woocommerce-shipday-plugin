...
class Shipday_Woo_DateTime_Util {
    ...
    public static function get_default_settings() {
        ...
        // Other settings
        $data['delivery_heading_checkout'] = get_option('shipday_delivery_pickup_label', "Delivery/Pickup info");
        $data['enable_delivery_option'] = get_option('shipday_enable_delivery_option', "no") === "yes";
        $data['delivery_option_field_label'] = __("Order Option", "woo-delivery");
        ...
        $data['delivery_date_field_label'] = __("Delivery Date", "woo-delivery");
        ...
        $data['delivery_time_field_label'] = __("Delivery Time", "woo-delivery");
        ...
        $data['pickup_date_field_label'] = __("Pickup Date", "woo-delivery");
        ...
        $data['pickup_time_field_label'] = __("Pickup Time", "woo-delivery");
        ...
        // Localization
        $data['checkout_delivery_option_notice'] = __("Please select order type", "woo-delivery");
        $data['checkout_date_notice'] = __("Please enter delivery date", "woo-delivery");
        $data['checkout_pickup_date_notice'] = __("Please enter pickup date", "woo-delivery");
        $data['checkout_time_notice'] = __("Please select delivery time", "woo-delivery");
        $data['checkout_pickup_time_notice'] = __("Please select pickup time", "woo-delivery");
        $data['select_order_type_text'] = __("Select order type", "woo-delivery");
        $data['select_delivery_time_text'] = __("Select delivery time", "woo-delivery");
        $data['select_pickup_time_text'] = __("Select pickup time", "woo-delivery");
