...
We also support Multi-vendor marketplaces using Dokan and WCFM.
...
2. Click on the Settings & go to Shipday tab and fill the form.
3. If you are using multi-vendor plugin then select Multiple pick up location.
4. Shipday API key find
5. shipday API key find 
